...
def _resnet(arch, block, layers, path_dim, act, num_classes, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        print('../pathomic_fusion_20211126/pretrained_resnet/' + resnet_pretrained[arch])
        checkpoint = torch.load('../pathomic_fusion_20211126/pretrained_resnet/' + resnet_pretrained[arch])
