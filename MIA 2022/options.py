...
def parse_args():
    ...
    parser.add_argument('--select_neg_pairs', type=str, default="False", 
        help='whether to select negative pairs for the CRD loss.')
    parser.add_argument('--neg_reweight', type=str, default="False", 
        help='whether to reweight the negative pairs for the CRD loss.')        
    ...
    parser.add_argument('--fixed_model', type=str, default='1216_pofusion_0.1tsvd_bs16_dim128', help='mode')
    ...
    ### for distillation loss reweighting.
    parser.add_argument('--grads_m', type=float,  default=0.5, help='ema_decay')
    parser.add_argument('--grads_thresh', type=str,  default='True', help='whether use threshold to reweight the loss')
    parser.add_argument('--thresh', type=float,  default=0.1, help='threshold to reweight different losses')
